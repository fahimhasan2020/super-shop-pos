                    ...
                    <div class="col-md-8">
                                ...
                                <div class="col-md-8 col-sm-8">
                                    ...
                                    <ul class="list-inline">
                                        <li class="place"><i class="fa fa-map-marker"></i>
                                            <span class="bl-sort">in</span>Rome, Italy</li>
                                        <li class="date"><i class="fa fa-calendar"></i>27.6.2014 at 17.33</li>
                                    </ul>
                                    <p class="bl-sort">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Proin nibh augue,suscipit a, scelerisque sed, lacinia in, mi.</p>
                        ...
                        <div class="blog-list">
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    <div class="blog-list-img">
                                        <img class="" src="img/content/blog-post-2.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-md-8 col-sm-8">
                                    <h5><a href="#">News Title Goes Here</a>
                        ...
                        <div class="blog-list">
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    <div class="blog-list-img">
                                        <img class="" src="img/content/blog-post-3.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-md-8 col-sm-8">
                                    <h5><a href="#">News Title Goes Here</a>
                        ...
                        <div class="blog-list">
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    <div class="blog-list-img">
                                        <img class="" src="img/content/blog-post-4.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-md-8 col-sm-8">
                                    <h5><a href="#">News Title Goes Here</a>
                        ...
                        <div class="blog-list">
                            <div class="row">
                                <div class="col-md-4 col-sm-4">
                                    <div class="blog-list-img">
                                        <img class="" src="img/content/blog-post-5.jpg" alt="">
                                    </div>
                                </div>
                                <div class="col-md-8 col-sm-8">
                                    <h5><a href="#">News Title Goes Here</a>
                                ...
                                <div class="blog-latest">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-3 col-xs-4">
                                            <img class="" src="img/content/lt-blog-img.jpg" alt="">
                                        </div>
